...
\section{Compétences}
\cvitem{Programmation}{R et Bioconductor, JAVA, Python, Shell, HTML/CSS, Qt, \LaTeX, SQL.}
\cvitem{Data mining}{SVM, réseaux de neurones, clustering hiérarchique, arbres décisionnels, règles d'association.}
\cvitem{Séquençage haut-débit}{Technologies Illumina et 454 : De Novo, Amplicons, RNA-Seq.}
\cvitem{Biologie Moléculaire}{Séquençage Sanger, PCR, PCR temps réel, extractions.}
