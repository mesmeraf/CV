...
{
\begin{itemize}
\item Détection de variants SARS-CoV2 à partir de données de séquençage PacBio.
\item Développement de pipelines Snakemake sur données long et short reads:
	\begin{itemize}
	\item Classification des variants du SARS-CoV2.
...
Étude par RNA-Seq du métabolisme de l'ARN messager dans les opérons : Rôle des BIME chez \textit{E. Coli}.
	...
	\item Étude de la stabilité des structures secondaires des BIME par rapport à leurs séquences ancêtres reconstruites.\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak
	\end{itemize}
}
...
\cventry{09/2009 - 07/2012}{Licence de Bioinformatique}{CNAM, cours du soir}{Paris}{}{
\begin{itemize}
